                    ...
                    <div className="content">
                        ...
                        <footer>
                            <div className="made-with-love">
                                Made with <i className="fas fa-heart footer__heart"></i> by <a href='https://github.com/CodyHolmes/' rel="noopener noreferrer" className="personal-github-link" target="_blank">Cody Holmes</a>
                            </div>
                        </footer>
                    </div>
                </div>
